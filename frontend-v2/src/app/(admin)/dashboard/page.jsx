  ...
  return (
    <div className="space-y-10 font-lato">
      ...
      <div className="grid sm:grid-cols-2 md:grid-cols-4 gap-4">
        <QuickCard title="Add Product" onClick={() => router.push("/dashboard/products")} />
        <QuickCard title="Add Category" onClick={() => router.push("/dashboard/categories")} />
        <QuickCard title="View Queries" onClick={() => router.push("/dashboard/queries")} />
        <QuickCard title="Manage Users" onClick={() => router.push("/dashboard/users")} />
      </div>
