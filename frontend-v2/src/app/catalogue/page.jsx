// app/catalogue/page.jsx (or pages/catalogue.jsx for Pages Router)
"use client";
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {catalogues.map((cat, i) => (
              <ScrollReveal key={cat.id} delay={Math.min(i + 1, 6)}>
                <div
                  data-testid={`catalogue-card-${cat.id}`}
                  className="group card-hover"
                >
                  <div className="img-zoom-container aspect-[3/4] bg-gray-100 relative">
                    <Image
                      src={cat.image}
                  ...
                  <div className="pt-5 flex items-center justify-between">
                    <div>
                      <h3 className="text-base font-normal text-brand-charcoal">
                        {cat.brand}
                      </h3>
                    ...
                    <a
                      ...
                      download
                      data-testid={`download-btn-${cat.id}`}
